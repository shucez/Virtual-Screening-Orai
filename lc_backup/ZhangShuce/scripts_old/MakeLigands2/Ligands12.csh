...
cd ~/Zhangsc/VS
#mkdir ~/Zhangsc/VS/etc12
mkdir ~/Zhangsc/VS/Ligands/Ligands12

# make the Ligands directory the current working directory
cd ~/Zhangsc/VS/Ligands/Ligands12
#mkdir test
#cd test
...
cat ~/Zhangsc/VS/Ligands/23_p0.12.mol2 | csplit -ftmp -n4 -ks - '%^@.TRIPOS.MOLECULE%' '/^@.TRIPOS.MOLECULE/' '{*}'
