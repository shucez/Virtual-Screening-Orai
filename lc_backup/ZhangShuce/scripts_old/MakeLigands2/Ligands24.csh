...
cd ~/Zhangsc/VS
#mkdir ~/Zhangsc/VS/etc24
mkdir ~/Zhangsc/VS/Ligands/Ligands24

# make the Ligands directory the current working directory
cd ~/Zhangsc/VS/Ligands/Ligands24
#mkdir test
#cd test
...
cat ~/Zhangsc/VS/Ligands/23_p0.24.mol2 | csplit -ftmp -n4 -ks - '%^@.TRIPOS.MOLECULE%' '/^@.TRIPOS.MOLECULE/' '{*}'
