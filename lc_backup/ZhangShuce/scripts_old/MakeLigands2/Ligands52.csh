...
cd ~/Zhangsc/VS
#mkdir ~/Zhangsc/VS/etc52
mkdir ~/Zhangsc/VS/Ligands/Ligands52

# make the Ligands directory the current working directory
cd ~/Zhangsc/VS/Ligands/Ligands52
#mkdir test
#cd test
...
cat ~/Zhangsc/VS/Ligands/23_p0.52.mol2 | csplit -ftmp -n4 -ks - '%^@.TRIPOS.MOLECULE%' '/^@.TRIPOS.MOLECULE/' '{*}'
