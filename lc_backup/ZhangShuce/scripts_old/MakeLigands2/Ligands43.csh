...
cd ~/Zhangsc/VS
#mkdir ~/Zhangsc/VS/etc43
mkdir ~/Zhangsc/VS/Ligands/Ligands43

# make the Ligands directory the current working directory
cd ~/Zhangsc/VS/Ligands/Ligands43
#mkdir test
#cd test
...
cat ~/Zhangsc/VS/Ligands/23_p0.43.mol2 | csplit -ftmp -n4 -ks - '%^@.TRIPOS.MOLECULE%' '/^@.TRIPOS.MOLECULE/' '{*}'
