...
cd ~/Zhangsc/VS
#mkdir ~/Zhangsc/VS/etc71
mkdir ~/Zhangsc/VS/Ligands/Ligands71

# make the Ligands directory the current working directory
cd ~/Zhangsc/VS/Ligands/Ligands71
#mkdir test
#cd test
...
cat ~/Zhangsc/VS/Ligands/23_p0.71.mol2 | csplit -ftmp -n4 -ks - '%^@.TRIPOS.MOLECULE%' '/^@.TRIPOS.MOLECULE/' '{*}'
