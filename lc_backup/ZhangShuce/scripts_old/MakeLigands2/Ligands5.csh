...
cd ~/Zhangsc/VS
#mkdir ~/Zhangsc/VS/etc5
mkdir ~/Zhangsc/VS/Ligands/Ligands5

# make the Ligands directory the current working directory
cd ~/Zhangsc/VS/Ligands/Ligands5
#mkdir test
#cd test
...
cat ~/Zhangsc/VS/Ligands/23_p0.5.mol2 | csplit -ftmp -n4 -ks - '%^@.TRIPOS.MOLECULE%' '/^@.TRIPOS.MOLECULE/' '{*}'
