...
cd ~/Zhangsc/VS
#mkdir ~/Zhangsc/VS/etc8
mkdir ~/Zhangsc/VS/Ligands/Ligands8

# make the Ligands directory the current working directory
cd ~/Zhangsc/VS/Ligands/Ligands8
#mkdir test
#cd test
...
cat ~/Zhangsc/VS/Ligands/23_p0.8.mol2 | csplit -ftmp -n4 -ks - '%^@.TRIPOS.MOLECULE%' '/^@.TRIPOS.MOLECULE/' '{*}'
