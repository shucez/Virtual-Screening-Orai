...
cd ~/Zhangsc/VS
#mkdir ~/Zhangsc/VS/etc9
mkdir ~/Zhangsc/VS/Ligands/Ligands9

# make the Ligands directory the current working directory
cd ~/Zhangsc/VS/Ligands/Ligands9
#mkdir test
#cd test
...
cat ~/Zhangsc/VS/Ligands/23_p0.9.mol2 | csplit -ftmp -n4 -ks - '%^@.TRIPOS.MOLECULE%' '/^@.TRIPOS.MOLECULE/' '{*}'
