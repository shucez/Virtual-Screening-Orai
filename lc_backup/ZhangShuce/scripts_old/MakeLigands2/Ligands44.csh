...
cd ~/Zhangsc/VS
#mkdir ~/Zhangsc/VS/etc44
mkdir ~/Zhangsc/VS/Ligands/Ligands44

# make the Ligands directory the current working directory
cd ~/Zhangsc/VS/Ligands/Ligands44
#mkdir test
#cd test
...
cat ~/Zhangsc/VS/Ligands/23_p0.44.mol2 | csplit -ftmp -n4 -ks - '%^@.TRIPOS.MOLECULE%' '/^@.TRIPOS.MOLECULE/' '{*}'
