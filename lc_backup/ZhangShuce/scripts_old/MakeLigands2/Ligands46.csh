...
cd ~/Zhangsc/VS
#mkdir ~/Zhangsc/VS/etc46
mkdir ~/Zhangsc/VS/Ligands/Ligands46

# make the Ligands directory the current working directory
cd ~/Zhangsc/VS/Ligands/Ligands46
#mkdir test
#cd test
...
cat ~/Zhangsc/VS/Ligands/23_p0.46.mol2 | csplit -ftmp -n4 -ks - '%^@.TRIPOS.MOLECULE%' '/^@.TRIPOS.MOLECULE/' '{*}'
