...
cd ~/Zhangsc/VS
#mkdir ~/Zhangsc/VS/etc37
mkdir ~/Zhangsc/VS/Ligands/Ligands37

# make the Ligands directory the current working directory
cd ~/Zhangsc/VS/Ligands/Ligands37
#mkdir test
#cd test
...
cat ~/Zhangsc/VS/Ligands/23_p0.37.mol2 | csplit -ftmp -n4 -ks - '%^@.TRIPOS.MOLECULE%' '/^@.TRIPOS.MOLECULE/' '{*}'
