...
cd ~/Zhangsc/VS
#mkdir ~/Zhangsc/VS/etc87
mkdir ~/Zhangsc/VS/Ligands/Ligands87

# make the Ligands directory the current working directory
cd ~/Zhangsc/VS/Ligands/Ligands87
#mkdir test
#cd test
...
cat ~/Zhangsc/VS/Ligands/23_p1.7.mol2 | csplit -ftmp -n4 -ks - '%^@.TRIPOS.MOLECULE%' '/^@.TRIPOS.MOLECULE/' '{*}'
