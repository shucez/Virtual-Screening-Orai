...
cd ~/Zhangsc/VS
#mkdir ~/Zhangsc/VS/etc41
mkdir ~/Zhangsc/VS/Ligands/Ligands41

# make the Ligands directory the current working directory
cd ~/Zhangsc/VS/Ligands/Ligands41
#mkdir test
#cd test
...
cat ~/Zhangsc/VS/Ligands/23_p0.41.mol2 | csplit -ftmp -n4 -ks - '%^@.TRIPOS.MOLECULE%' '/^@.TRIPOS.MOLECULE/' '{*}'
