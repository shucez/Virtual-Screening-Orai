...
cd ~/Zhangsc/VS
#mkdir ~/Zhangsc/VS/etc14
mkdir ~/Zhangsc/VS/Ligands/Ligands14

# make the Ligands directory the current working directory
cd ~/Zhangsc/VS/Ligands/Ligands14
#mkdir test
#cd test
...
cat ~/Zhangsc/VS/Ligands/23_p0.14.mol2 | csplit -ftmp -n4 -ks - '%^@.TRIPOS.MOLECULE%' '/^@.TRIPOS.MOLECULE/' '{*}'
