...
cd ~/Zhangsc/VS
#mkdir ~/Zhangsc/VS/etc85
mkdir ~/Zhangsc/VS/Ligands/Ligands85

# make the Ligands directory the current working directory
cd ~/Zhangsc/VS/Ligands/Ligands85
#mkdir test
#cd test
...
cat ~/Zhangsc/VS/Ligands/23_p1.5.mol2 | csplit -ftmp -n4 -ks - '%^@.TRIPOS.MOLECULE%' '/^@.TRIPOS.MOLECULE/' '{*}'
