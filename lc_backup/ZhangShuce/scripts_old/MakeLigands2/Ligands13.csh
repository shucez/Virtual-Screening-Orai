...
cd ~/Zhangsc/VS
#mkdir ~/Zhangsc/VS/etc13
mkdir ~/Zhangsc/VS/Ligands/Ligands13

# make the Ligands directory the current working directory
cd ~/Zhangsc/VS/Ligands/Ligands13
#mkdir test
#cd test
...
cat ~/Zhangsc/VS/Ligands/23_p0.13.mol2 | csplit -ftmp -n4 -ks - '%^@.TRIPOS.MOLECULE%' '/^@.TRIPOS.MOLECULE/' '{*}'
