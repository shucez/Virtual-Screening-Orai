...
cd ~/Zhangsc/VS
#mkdir ~/Zhangsc/VS/etc33
mkdir ~/Zhangsc/VS/Ligands/Ligands33

# make the Ligands directory the current working directory
cd ~/Zhangsc/VS/Ligands/Ligands33
#mkdir test
#cd test
...
cat ~/Zhangsc/VS/Ligands/23_p0.33.mol2 | csplit -ftmp -n4 -ks - '%^@.TRIPOS.MOLECULE%' '/^@.TRIPOS.MOLECULE/' '{*}'
