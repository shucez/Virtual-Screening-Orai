...
cd ~/Zhangsc/VS
#mkdir ~/Zhangsc/VS/etc31
mkdir ~/Zhangsc/VS/Ligands/Ligands31

# make the Ligands directory the current working directory
cd ~/Zhangsc/VS/Ligands/Ligands31
#mkdir test
#cd test
...
cat ~/Zhangsc/VS/Ligands/23_p0.31.mol2 | csplit -ftmp -n4 -ks - '%^@.TRIPOS.MOLECULE%' '/^@.TRIPOS.MOLECULE/' '{*}'
