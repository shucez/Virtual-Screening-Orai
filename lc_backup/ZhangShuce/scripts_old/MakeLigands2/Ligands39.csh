...
cd ~/Zhangsc/VS
#mkdir ~/Zhangsc/VS/etc39
mkdir ~/Zhangsc/VS/Ligands/Ligands39

# make the Ligands directory the current working directory
cd ~/Zhangsc/VS/Ligands/Ligands39
#mkdir test
#cd test
...
cat ~/Zhangsc/VS/Ligands/23_p0.39.mol2 | csplit -ftmp -n4 -ks - '%^@.TRIPOS.MOLECULE%' '/^@.TRIPOS.MOLECULE/' '{*}'
