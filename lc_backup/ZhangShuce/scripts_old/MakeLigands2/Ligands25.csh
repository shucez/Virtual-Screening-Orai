...
cd ~/Zhangsc/VS
#mkdir ~/Zhangsc/VS/etc25
mkdir ~/Zhangsc/VS/Ligands/Ligands25

# make the Ligands directory the current working directory
cd ~/Zhangsc/VS/Ligands/Ligands25
#mkdir test
#cd test
...
cat ~/Zhangsc/VS/Ligands/23_p0.25.mol2 | csplit -ftmp -n4 -ks - '%^@.TRIPOS.MOLECULE%' '/^@.TRIPOS.MOLECULE/' '{*}'
