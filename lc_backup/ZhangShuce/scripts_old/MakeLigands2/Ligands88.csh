...
cd ~/Zhangsc/VS
#mkdir ~/Zhangsc/VS/etc88
mkdir ~/Zhangsc/VS/Ligands/Ligands88

# make the Ligands directory the current working directory
cd ~/Zhangsc/VS/Ligands/Ligands88
#mkdir test
#cd test
...
cat ~/Zhangsc/VS/Ligands/23_p1.8.mol2 | csplit -ftmp -n4 -ks - '%^@.TRIPOS.MOLECULE%' '/^@.TRIPOS.MOLECULE/' '{*}'
