...
cd ~/Zhangsc/VS
#mkdir ~/Zhangsc/VS/etc18
mkdir ~/Zhangsc/VS/Ligands/Ligands18

# make the Ligands directory the current working directory
cd ~/Zhangsc/VS/Ligands/Ligands18
#mkdir test
#cd test
...
cat ~/Zhangsc/VS/Ligands/23_p0.18.mol2 | csplit -ftmp -n4 -ks - '%^@.TRIPOS.MOLECULE%' '/^@.TRIPOS.MOLECULE/' '{*}'
