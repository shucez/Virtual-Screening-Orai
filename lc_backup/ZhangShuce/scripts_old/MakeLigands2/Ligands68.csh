...
cd ~/Zhangsc/VS
#mkdir ~/Zhangsc/VS/etc68
mkdir ~/Zhangsc/VS/Ligands/Ligands68

# make the Ligands directory the current working directory
cd ~/Zhangsc/VS/Ligands/Ligands68
#mkdir test
#cd test
...
cat ~/Zhangsc/VS/Ligands/23_p0.68.mol2 | csplit -ftmp -n4 -ks - '%^@.TRIPOS.MOLECULE%' '/^@.TRIPOS.MOLECULE/' '{*}'
