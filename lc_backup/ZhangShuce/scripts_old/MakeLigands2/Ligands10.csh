...
cd ~/Zhangsc/VS
#mkdir ~/Zhangsc/VS/etc10
mkdir ~/Zhangsc/VS/Ligands/Ligands10

# make the Ligands directory the current working directory
cd ~/Zhangsc/VS/Ligands/Ligands10
#mkdir test
#cd test
...
cat ~/Zhangsc/VS/Ligands/23_p0.10.mol2 | csplit -ftmp -n4 -ks - '%^@.TRIPOS.MOLECULE%' '/^@.TRIPOS.MOLECULE/' '{*}'
