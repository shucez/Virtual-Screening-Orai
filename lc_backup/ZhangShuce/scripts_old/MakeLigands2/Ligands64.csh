...
cd ~/Zhangsc/VS
#mkdir ~/Zhangsc/VS/etc64
mkdir ~/Zhangsc/VS/Ligands/Ligands64

# make the Ligands directory the current working directory
cd ~/Zhangsc/VS/Ligands/Ligands64
#mkdir test
#cd test
...
cat ~/Zhangsc/VS/Ligands/23_p0.64.mol2 | csplit -ftmp -n4 -ks - '%^@.TRIPOS.MOLECULE%' '/^@.TRIPOS.MOLECULE/' '{*}'
