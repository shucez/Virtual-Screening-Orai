...
cd ~/Zhangsc/VS
#mkdir ~/Zhangsc/VS/etc72
mkdir ~/Zhangsc/VS/Ligands/Ligands72

# make the Ligands directory the current working directory
cd ~/Zhangsc/VS/Ligands/Ligands72
#mkdir test
#cd test
...
cat ~/Zhangsc/VS/Ligands/23_p0.72.mol2 | csplit -ftmp -n4 -ks - '%^@.TRIPOS.MOLECULE%' '/^@.TRIPOS.MOLECULE/' '{*}'
