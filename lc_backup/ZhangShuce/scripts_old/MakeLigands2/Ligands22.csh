...
cd ~/Zhangsc/VS
#mkdir ~/Zhangsc/VS/etc22
mkdir ~/Zhangsc/VS/Ligands/Ligands22

# make the Ligands directory the current working directory
cd ~/Zhangsc/VS/Ligands/Ligands22
#mkdir test
#cd test
...
cat ~/Zhangsc/VS/Ligands/23_p0.22.mol2 | csplit -ftmp -n4 -ks - '%^@.TRIPOS.MOLECULE%' '/^@.TRIPOS.MOLECULE/' '{*}'
