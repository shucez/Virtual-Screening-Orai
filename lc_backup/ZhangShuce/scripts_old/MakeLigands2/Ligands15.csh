...
cd ~/Zhangsc/VS
#mkdir ~/Zhangsc/VS/etc15
mkdir ~/Zhangsc/VS/Ligands/Ligands15

# make the Ligands directory the current working directory
cd ~/Zhangsc/VS/Ligands/Ligands15
#mkdir test
#cd test
...
cat ~/Zhangsc/VS/Ligands/23_p0.15.mol2 | csplit -ftmp -n4 -ks - '%^@.TRIPOS.MOLECULE%' '/^@.TRIPOS.MOLECULE/' '{*}'
