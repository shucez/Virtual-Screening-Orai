...
cd ~/Zhangsc/VS
#mkdir ~/Zhangsc/VS/etc40
mkdir ~/Zhangsc/VS/Ligands/Ligands40

# make the Ligands directory the current working directory
cd ~/Zhangsc/VS/Ligands/Ligands40
#mkdir test
#cd test
...
cat ~/Zhangsc/VS/Ligands/23_p0.40.mol2 | csplit -ftmp -n4 -ks - '%^@.TRIPOS.MOLECULE%' '/^@.TRIPOS.MOLECULE/' '{*}'
