...
cd ~/Zhangsc/VS
#mkdir ~/Zhangsc/VS/etc45
mkdir ~/Zhangsc/VS/Ligands/Ligands45

# make the Ligands directory the current working directory
cd ~/Zhangsc/VS/Ligands/Ligands45
#mkdir test
#cd test
...
cat ~/Zhangsc/VS/Ligands/23_p0.45.mol2 | csplit -ftmp -n4 -ks - '%^@.TRIPOS.MOLECULE%' '/^@.TRIPOS.MOLECULE/' '{*}'
