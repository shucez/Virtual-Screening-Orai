...
cd ~/Zhangsc/VS
#mkdir ~/Zhangsc/VS/etc73
mkdir ~/Zhangsc/VS/Ligands/Ligands73

# make the Ligands directory the current working directory
cd ~/Zhangsc/VS/Ligands/Ligands73
#mkdir test
#cd test
...
cat ~/Zhangsc/VS/Ligands/23_p0.73.mol2 | csplit -ftmp -n4 -ks - '%^@.TRIPOS.MOLECULE%' '/^@.TRIPOS.MOLECULE/' '{*}'
