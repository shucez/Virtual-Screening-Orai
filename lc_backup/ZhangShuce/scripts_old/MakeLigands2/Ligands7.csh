...
cd ~/Zhangsc/VS
#mkdir ~/Zhangsc/VS/etc7
mkdir ~/Zhangsc/VS/Ligands/Ligands7

# make the Ligands directory the current working directory
cd ~/Zhangsc/VS/Ligands/Ligands7
#mkdir test
#cd test
...
cat ~/Zhangsc/VS/Ligands/23_p0.7.mol2 | csplit -ftmp -n4 -ks - '%^@.TRIPOS.MOLECULE%' '/^@.TRIPOS.MOLECULE/' '{*}'
