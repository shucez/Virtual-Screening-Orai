...
cd ~/Zhangsc/VS
#mkdir ~/Zhangsc/VS/etc29
mkdir ~/Zhangsc/VS/Ligands/Ligands29

# make the Ligands directory the current working directory
cd ~/Zhangsc/VS/Ligands/Ligands29
#mkdir test
#cd test
...
cat ~/Zhangsc/VS/Ligands/23_p0.29.mol2 | csplit -ftmp -n4 -ks - '%^@.TRIPOS.MOLECULE%' '/^@.TRIPOS.MOLECULE/' '{*}'
