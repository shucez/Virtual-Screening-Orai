...
cd ~/Zhangsc/VS
#mkdir ~/Zhangsc/VS/etc55
mkdir ~/Zhangsc/VS/Ligands/Ligands55

# make the Ligands directory the current working directory
cd ~/Zhangsc/VS/Ligands/Ligands55
#mkdir test
#cd test
...
cat ~/Zhangsc/VS/Ligands/23_p0.55.mol2 | csplit -ftmp -n4 -ks - '%^@.TRIPOS.MOLECULE%' '/^@.TRIPOS.MOLECULE/' '{*}'
