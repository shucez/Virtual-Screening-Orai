...
cd ~/Zhangsc/VS
#mkdir ~/Zhangsc/VS/etc60
mkdir ~/Zhangsc/VS/Ligands/Ligands60

# make the Ligands directory the current working directory
cd ~/Zhangsc/VS/Ligands/Ligands60
#mkdir test
#cd test
...
cat ~/Zhangsc/VS/Ligands/23_p0.60.mol2 | csplit -ftmp -n4 -ks - '%^@.TRIPOS.MOLECULE%' '/^@.TRIPOS.MOLECULE/' '{*}'
