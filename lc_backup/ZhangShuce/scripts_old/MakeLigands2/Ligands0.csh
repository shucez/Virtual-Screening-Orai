...
cd ~/Zhangsc/VS
#mkdir ~/Zhangsc/VS/etc0
mkdir ~/Zhangsc/VS/Ligands/Ligands0

# make the Ligands directory the current working directory
cd ~/Zhangsc/VS/Ligands/Ligands0
#mkdir test
#cd test
...
cat ~/Zhangsc/VS/Ligands/23_p0.0.mol2 | csplit -ftmp -n4 -ks - '%^@.TRIPOS.MOLECULE%' '/^@.TRIPOS.MOLECULE/' '{*}'
