...
cd ~/Zhangsc/VS
#mkdir ~/Zhangsc/VS/etc3
mkdir ~/Zhangsc/VS/Ligands/Ligands3

# make the Ligands directory the current working directory
cd ~/Zhangsc/VS/Ligands/Ligands3
#mkdir test
#cd test
...
cat ~/Zhangsc/VS/Ligands/23_p0.3.mol2 | csplit -ftmp -n4 -ks - '%^@.TRIPOS.MOLECULE%' '/^@.TRIPOS.MOLECULE/' '{*}'
