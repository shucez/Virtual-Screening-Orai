...
cd ~/Zhangsc/VS
#mkdir ~/Zhangsc/VS/etc47
mkdir ~/Zhangsc/VS/Ligands/Ligands47

# make the Ligands directory the current working directory
cd ~/Zhangsc/VS/Ligands/Ligands47
#mkdir test
#cd test
...
cat ~/Zhangsc/VS/Ligands/23_p0.47.mol2 | csplit -ftmp -n4 -ks - '%^@.TRIPOS.MOLECULE%' '/^@.TRIPOS.MOLECULE/' '{*}'
