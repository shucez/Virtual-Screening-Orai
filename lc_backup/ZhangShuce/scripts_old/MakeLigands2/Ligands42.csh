...
cd ~/Zhangsc/VS
#mkdir ~/Zhangsc/VS/etc42
mkdir ~/Zhangsc/VS/Ligands/Ligands42

# make the Ligands directory the current working directory
cd ~/Zhangsc/VS/Ligands/Ligands42
#mkdir test
#cd test
...
cat ~/Zhangsc/VS/Ligands/23_p0.42.mol2 | csplit -ftmp -n4 -ks - '%^@.TRIPOS.MOLECULE%' '/^@.TRIPOS.MOLECULE/' '{*}'
