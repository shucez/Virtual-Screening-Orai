...
cd ~/Zhangsc/VS
#mkdir ~/Zhangsc/VS/etc50
mkdir ~/Zhangsc/VS/Ligands/Ligands50

# make the Ligands directory the current working directory
cd ~/Zhangsc/VS/Ligands/Ligands50
#mkdir test
#cd test
...
cat ~/Zhangsc/VS/Ligands/23_p0.50.mol2 | csplit -ftmp -n4 -ks - '%^@.TRIPOS.MOLECULE%' '/^@.TRIPOS.MOLECULE/' '{*}'
