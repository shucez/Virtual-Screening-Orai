...
cd ~/Zhangsc/VS
#mkdir ~/Zhangsc/VS/etc56
mkdir ~/Zhangsc/VS/Ligands/Ligands56

# make the Ligands directory the current working directory
cd ~/Zhangsc/VS/Ligands/Ligands56
#mkdir test
#cd test
...
cat ~/Zhangsc/VS/Ligands/23_p0.56.mol2 | csplit -ftmp -n4 -ks - '%^@.TRIPOS.MOLECULE%' '/^@.TRIPOS.MOLECULE/' '{*}'
