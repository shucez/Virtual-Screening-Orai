...
cd ~/Zhangsc/VS
#mkdir ~/Zhangsc/VS/etc89
mkdir ~/Zhangsc/VS/Ligands/Ligands89

# make the Ligands directory the current working directory
cd ~/Zhangsc/VS/Ligands/Ligands89
#mkdir test
#cd test
...
cat ~/Zhangsc/VS/Ligands/23_p1.9.mol2 | csplit -ftmp -n4 -ks - '%^@.TRIPOS.MOLECULE%' '/^@.TRIPOS.MOLECULE/' '{*}'
