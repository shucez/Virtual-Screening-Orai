...
cd ~/Zhangsc/VS
#mkdir ~/Zhangsc/VS/etc32
mkdir ~/Zhangsc/VS/Ligands/Ligands32

# make the Ligands directory the current working directory
cd ~/Zhangsc/VS/Ligands/Ligands32
#mkdir test
#cd test
...
cat ~/Zhangsc/VS/Ligands/23_p0.32.mol2 | csplit -ftmp -n4 -ks - '%^@.TRIPOS.MOLECULE%' '/^@.TRIPOS.MOLECULE/' '{*}'
