...
cd ~/Zhangsc/VS
#mkdir ~/Zhangsc/VS/etc34
mkdir ~/Zhangsc/VS/Ligands/Ligands34

# make the Ligands directory the current working directory
cd ~/Zhangsc/VS/Ligands/Ligands34
#mkdir test
#cd test
...
cat ~/Zhangsc/VS/Ligands/23_p0.34.mol2 | csplit -ftmp -n4 -ks - '%^@.TRIPOS.MOLECULE%' '/^@.TRIPOS.MOLECULE/' '{*}'
