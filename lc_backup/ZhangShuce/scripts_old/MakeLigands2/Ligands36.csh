...
cd ~/Zhangsc/VS
#mkdir ~/Zhangsc/VS/etc36
mkdir ~/Zhangsc/VS/Ligands/Ligands36

# make the Ligands directory the current working directory
cd ~/Zhangsc/VS/Ligands/Ligands36
#mkdir test
#cd test
...
cat ~/Zhangsc/VS/Ligands/23_p0.36.mol2 | csplit -ftmp -n4 -ks - '%^@.TRIPOS.MOLECULE%' '/^@.TRIPOS.MOLECULE/' '{*}'
