...
cd ~/Zhangsc/VS
#mkdir ~/Zhangsc/VS/etc21
mkdir ~/Zhangsc/VS/Ligands/Ligands21

# make the Ligands directory the current working directory
cd ~/Zhangsc/VS/Ligands/Ligands21
#mkdir test
#cd test
...
cat ~/Zhangsc/VS/Ligands/23_p0.21.mol2 | csplit -ftmp -n4 -ks - '%^@.TRIPOS.MOLECULE%' '/^@.TRIPOS.MOLECULE/' '{*}'
