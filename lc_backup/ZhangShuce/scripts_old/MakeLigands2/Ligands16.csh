...
cd ~/Zhangsc/VS
#mkdir ~/Zhangsc/VS/etc16
mkdir ~/Zhangsc/VS/Ligands/Ligands16

# make the Ligands directory the current working directory
cd ~/Zhangsc/VS/Ligands/Ligands16
#mkdir test
#cd test
...
cat ~/Zhangsc/VS/Ligands/23_p0.16.mol2 | csplit -ftmp -n4 -ks - '%^@.TRIPOS.MOLECULE%' '/^@.TRIPOS.MOLECULE/' '{*}'
