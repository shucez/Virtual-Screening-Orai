...
cd ~/Zhangsc/VS
#mkdir ~/Zhangsc/VS/etc84
mkdir ~/Zhangsc/VS/Ligands/Ligands84

# make the Ligands directory the current working directory
cd ~/Zhangsc/VS/Ligands/Ligands84
#mkdir test
#cd test
...
cat ~/Zhangsc/VS/Ligands/23_p1.4.mol2 | csplit -ftmp -n4 -ks - '%^@.TRIPOS.MOLECULE%' '/^@.TRIPOS.MOLECULE/' '{*}'
