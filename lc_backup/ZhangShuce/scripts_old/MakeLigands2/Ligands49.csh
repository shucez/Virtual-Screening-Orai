...
cd ~/Zhangsc/VS
#mkdir ~/Zhangsc/VS/etc49
mkdir ~/Zhangsc/VS/Ligands/Ligands49

# make the Ligands directory the current working directory
cd ~/Zhangsc/VS/Ligands/Ligands49
#mkdir test
#cd test
...
cat ~/Zhangsc/VS/Ligands/23_p0.49.mol2 | csplit -ftmp -n4 -ks - '%^@.TRIPOS.MOLECULE%' '/^@.TRIPOS.MOLECULE/' '{*}'
