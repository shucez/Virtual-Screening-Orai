...
cd ~/Zhangsc/VS
#mkdir ~/Zhangsc/VS/etc63
mkdir ~/Zhangsc/VS/Ligands/Ligands63

# make the Ligands directory the current working directory
cd ~/Zhangsc/VS/Ligands/Ligands63
#mkdir test
#cd test
...
cat ~/Zhangsc/VS/Ligands/23_p0.63.mol2 | csplit -ftmp -n4 -ks - '%^@.TRIPOS.MOLECULE%' '/^@.TRIPOS.MOLECULE/' '{*}'
