...
cd ~/Zhangsc/VS
#mkdir ~/Zhangsc/VS/etc17
mkdir ~/Zhangsc/VS/Ligands/Ligands17

# make the Ligands directory the current working directory
cd ~/Zhangsc/VS/Ligands/Ligands17
#mkdir test
#cd test
...
cat ~/Zhangsc/VS/Ligands/23_p0.17.mol2 | csplit -ftmp -n4 -ks - '%^@.TRIPOS.MOLECULE%' '/^@.TRIPOS.MOLECULE/' '{*}'
