...
cd ~/Zhangsc/VS
#mkdir ~/Zhangsc/VS/etc54
mkdir ~/Zhangsc/VS/Ligands/Ligands54

# make the Ligands directory the current working directory
cd ~/Zhangsc/VS/Ligands/Ligands54
#mkdir test
#cd test
...
cat ~/Zhangsc/VS/Ligands/23_p0.54.mol2 | csplit -ftmp -n4 -ks - '%^@.TRIPOS.MOLECULE%' '/^@.TRIPOS.MOLECULE/' '{*}'
