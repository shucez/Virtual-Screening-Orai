...
cd ~/Zhangsc/VS
#mkdir ~/Zhangsc/VS/etc19
mkdir ~/Zhangsc/VS/Ligands/Ligands19

# make the Ligands directory the current working directory
cd ~/Zhangsc/VS/Ligands/Ligands19
#mkdir test
#cd test
...
cat ~/Zhangsc/VS/Ligands/23_p0.19.mol2 | csplit -ftmp -n4 -ks - '%^@.TRIPOS.MOLECULE%' '/^@.TRIPOS.MOLECULE/' '{*}'
