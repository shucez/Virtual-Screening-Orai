...
cd ~/Zhangsc/VS
#mkdir ~/Zhangsc/VS/etc30
mkdir ~/Zhangsc/VS/Ligands/Ligands30

# make the Ligands directory the current working directory
cd ~/Zhangsc/VS/Ligands/Ligands30
#mkdir test
#cd test
...
cat ~/Zhangsc/VS/Ligands/23_p0.30.mol2 | csplit -ftmp -n4 -ks - '%^@.TRIPOS.MOLECULE%' '/^@.TRIPOS.MOLECULE/' '{*}'
