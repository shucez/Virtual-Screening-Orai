...
cd ~/Zhangsc/VS
#mkdir ~/Zhangsc/VS/etc4
mkdir ~/Zhangsc/VS/Ligands/Ligands4

# make the Ligands directory the current working directory
cd ~/Zhangsc/VS/Ligands/Ligands4
#mkdir test
#cd test
...
cat ~/Zhangsc/VS/Ligands/23_p0.4.mol2 | csplit -ftmp -n4 -ks - '%^@.TRIPOS.MOLECULE%' '/^@.TRIPOS.MOLECULE/' '{*}'
