...
cd ~/Zhangsc/VS
#mkdir ~/Zhangsc/VS/etc53
mkdir ~/Zhangsc/VS/Ligands/Ligands53

# make the Ligands directory the current working directory
cd ~/Zhangsc/VS/Ligands/Ligands53
#mkdir test
#cd test
...
cat ~/Zhangsc/VS/Ligands/23_p0.53.mol2 | csplit -ftmp -n4 -ks - '%^@.TRIPOS.MOLECULE%' '/^@.TRIPOS.MOLECULE/' '{*}'
