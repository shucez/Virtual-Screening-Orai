...
cd ~/Zhangsc/VS
#mkdir ~/Zhangsc/VS/etc38
mkdir ~/Zhangsc/VS/Ligands/Ligands38

# make the Ligands directory the current working directory
cd ~/Zhangsc/VS/Ligands/Ligands38
#mkdir test
#cd test
...
cat ~/Zhangsc/VS/Ligands/23_p0.38.mol2 | csplit -ftmp -n4 -ks - '%^@.TRIPOS.MOLECULE%' '/^@.TRIPOS.MOLECULE/' '{*}'
