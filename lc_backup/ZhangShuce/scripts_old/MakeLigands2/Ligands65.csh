...
cd ~/Zhangsc/VS
#mkdir ~/Zhangsc/VS/etc65
mkdir ~/Zhangsc/VS/Ligands/Ligands65

# make the Ligands directory the current working directory
cd ~/Zhangsc/VS/Ligands/Ligands65
#mkdir test
#cd test
...
cat ~/Zhangsc/VS/Ligands/23_p0.65.mol2 | csplit -ftmp -n4 -ks - '%^@.TRIPOS.MOLECULE%' '/^@.TRIPOS.MOLECULE/' '{*}'
