...
cd ~/Zhangsc/VS
#mkdir ~/Zhangsc/VS/etc51
mkdir ~/Zhangsc/VS/Ligands/Ligands51

# make the Ligands directory the current working directory
cd ~/Zhangsc/VS/Ligands/Ligands51
#mkdir test
#cd test
...
cat ~/Zhangsc/VS/Ligands/23_p0.51.mol2 | csplit -ftmp -n4 -ks - '%^@.TRIPOS.MOLECULE%' '/^@.TRIPOS.MOLECULE/' '{*}'
