...
cd ~/Zhangsc/VS
#mkdir ~/Zhangsc/VS/etc70
mkdir ~/Zhangsc/VS/Ligands/Ligands70

# make the Ligands directory the current working directory
cd ~/Zhangsc/VS/Ligands/Ligands70
#mkdir test
#cd test
...
cat ~/Zhangsc/VS/Ligands/23_p0.70.mol2 | csplit -ftmp -n4 -ks - '%^@.TRIPOS.MOLECULE%' '/^@.TRIPOS.MOLECULE/' '{*}'
