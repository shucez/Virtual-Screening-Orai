...
cd ~/Zhangsc/VS
#mkdir ~/Zhangsc/VS/etc810
mkdir ~/Zhangsc/VS/Ligands/Ligands810

# make the Ligands directory the current working directory
cd ~/Zhangsc/VS/Ligands/Ligands810
#mkdir test
#cd test
...
cat ~/Zhangsc/VS/Ligands/23_p1.10.mol2 | csplit -ftmp -n4 -ks - '%^@.TRIPOS.MOLECULE%' '/^@.TRIPOS.MOLECULE/' '{*}'
