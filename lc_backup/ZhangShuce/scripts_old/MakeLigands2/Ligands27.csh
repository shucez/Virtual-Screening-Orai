...
cd ~/Zhangsc/VS
#mkdir ~/Zhangsc/VS/etc27
mkdir ~/Zhangsc/VS/Ligands/Ligands27

# make the Ligands directory the current working directory
cd ~/Zhangsc/VS/Ligands/Ligands27
#mkdir test
#cd test
...
cat ~/Zhangsc/VS/Ligands/23_p0.27.mol2 | csplit -ftmp -n4 -ks - '%^@.TRIPOS.MOLECULE%' '/^@.TRIPOS.MOLECULE/' '{*}'
