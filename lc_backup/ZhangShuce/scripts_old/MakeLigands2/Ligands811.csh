...
cd ~/Zhangsc/VS
#mkdir ~/Zhangsc/VS/etc811
mkdir ~/Zhangsc/VS/Ligands/Ligands811

# make the Ligands directory the current working directory
cd ~/Zhangsc/VS/Ligands/Ligands811
#mkdir test
#cd test
...
cat ~/Zhangsc/VS/Ligands/23_p1.11.mol2 | csplit -ftmp -n4 -ks - '%^@.TRIPOS.MOLECULE%' '/^@.TRIPOS.MOLECULE/' '{*}'
