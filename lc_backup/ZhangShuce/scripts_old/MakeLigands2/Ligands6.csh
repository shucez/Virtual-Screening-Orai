...
cd ~/Zhangsc/VS
#mkdir ~/Zhangsc/VS/etc6
mkdir ~/Zhangsc/VS/Ligands/Ligands6

# make the Ligands directory the current working directory
cd ~/Zhangsc/VS/Ligands/Ligands6
#mkdir test
#cd test
...
cat ~/Zhangsc/VS/Ligands/23_p0.6.mol2 | csplit -ftmp -n4 -ks - '%^@.TRIPOS.MOLECULE%' '/^@.TRIPOS.MOLECULE/' '{*}'
