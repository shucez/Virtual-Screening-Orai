...
cd ~/Zhangsc/VS
#mkdir ~/Zhangsc/VS/etc26
mkdir ~/Zhangsc/VS/Ligands/Ligands26

# make the Ligands directory the current working directory
cd ~/Zhangsc/VS/Ligands/Ligands26
#mkdir test
#cd test
...
cat ~/Zhangsc/VS/Ligands/23_p0.26.mol2 | csplit -ftmp -n4 -ks - '%^@.TRIPOS.MOLECULE%' '/^@.TRIPOS.MOLECULE/' '{*}'
