...
cd ~/Zhangsc/VS
#mkdir ~/Zhangsc/VS/etc2
mkdir ~/Zhangsc/VS/Ligands/Ligands2

# make the Ligands directory the current working directory
cd ~/Zhangsc/VS/Ligands/Ligands2
#mkdir test
#cd test
...
cat ~/Zhangsc/VS/Ligands/23_p0.2.mol2 | csplit -ftmp -n4 -ks - '%^@.TRIPOS.MOLECULE%' '/^@.TRIPOS.MOLECULE/' '{*}'
