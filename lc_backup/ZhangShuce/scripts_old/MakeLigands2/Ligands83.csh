...
cd ~/Zhangsc/VS
#mkdir ~/Zhangsc/VS/etc83
mkdir ~/Zhangsc/VS/Ligands/Ligands83

# make the Ligands directory the current working directory
cd ~/Zhangsc/VS/Ligands/Ligands83
#mkdir test
#cd test
...
cat ~/Zhangsc/VS/Ligands/23_p1.3.mol2 | csplit -ftmp -n4 -ks - '%^@.TRIPOS.MOLECULE%' '/^@.TRIPOS.MOLECULE/' '{*}'
