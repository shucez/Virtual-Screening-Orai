...
cd ~/Zhangsc/VS
#mkdir ~/Zhangsc/VS/etc67
mkdir ~/Zhangsc/VS/Ligands/Ligands67

# make the Ligands directory the current working directory
cd ~/Zhangsc/VS/Ligands/Ligands67
#mkdir test
#cd test
...
cat ~/Zhangsc/VS/Ligands/23_p0.67.mol2 | csplit -ftmp -n4 -ks - '%^@.TRIPOS.MOLECULE%' '/^@.TRIPOS.MOLECULE/' '{*}'
