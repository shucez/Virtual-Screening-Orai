...
cd ~/Zhangsc/VS
#mkdir ~/Zhangsc/VS/etc80
mkdir ~/Zhangsc/VS/Ligands/Ligands80

# make the Ligands directory the current working directory
cd ~/Zhangsc/VS/Ligands/Ligands80
#mkdir test
#cd test
...
cat ~/Zhangsc/VS/Ligands/23_p1.0.mol2 | csplit -ftmp -n4 -ks - '%^@.TRIPOS.MOLECULE%' '/^@.TRIPOS.MOLECULE/' '{*}'
