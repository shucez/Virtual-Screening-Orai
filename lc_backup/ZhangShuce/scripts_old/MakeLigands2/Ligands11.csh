...
cd ~/Zhangsc/VS
#mkdir ~/Zhangsc/VS/etc11
mkdir ~/Zhangsc/VS/Ligands/Ligands11

# make the Ligands directory the current working directory
cd ~/Zhangsc/VS/Ligands/Ligands11
#mkdir test
#cd test
...
cat ~/Zhangsc/VS/Ligands/23_p0.11.mol2 | csplit -ftmp -n4 -ks - '%^@.TRIPOS.MOLECULE%' '/^@.TRIPOS.MOLECULE/' '{*}'
