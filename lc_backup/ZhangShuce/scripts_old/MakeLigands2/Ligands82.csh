...
cd ~/Zhangsc/VS
#mkdir ~/Zhangsc/VS/etc82
mkdir ~/Zhangsc/VS/Ligands/Ligands82

# make the Ligands directory the current working directory
cd ~/Zhangsc/VS/Ligands/Ligands82
#mkdir test
#cd test
...
cat ~/Zhangsc/VS/Ligands/23_p1.2.mol2 | csplit -ftmp -n4 -ks - '%^@.TRIPOS.MOLECULE%' '/^@.TRIPOS.MOLECULE/' '{*}'
