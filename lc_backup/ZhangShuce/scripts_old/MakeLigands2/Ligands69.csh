...
cd ~/Zhangsc/VS
#mkdir ~/Zhangsc/VS/etc69
mkdir ~/Zhangsc/VS/Ligands/Ligands69

# make the Ligands directory the current working directory
cd ~/Zhangsc/VS/Ligands/Ligands69
#mkdir test
#cd test
...
cat ~/Zhangsc/VS/Ligands/23_p0.69.mol2 | csplit -ftmp -n4 -ks - '%^@.TRIPOS.MOLECULE%' '/^@.TRIPOS.MOLECULE/' '{*}'
