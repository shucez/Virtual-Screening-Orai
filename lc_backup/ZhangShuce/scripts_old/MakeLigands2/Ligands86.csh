...
cd ~/Zhangsc/VS
#mkdir ~/Zhangsc/VS/etc86
mkdir ~/Zhangsc/VS/Ligands/Ligands86

# make the Ligands directory the current working directory
cd ~/Zhangsc/VS/Ligands/Ligands86
#mkdir test
#cd test
...
cat ~/Zhangsc/VS/Ligands/23_p1.6.mol2 | csplit -ftmp -n4 -ks - '%^@.TRIPOS.MOLECULE%' '/^@.TRIPOS.MOLECULE/' '{*}'
