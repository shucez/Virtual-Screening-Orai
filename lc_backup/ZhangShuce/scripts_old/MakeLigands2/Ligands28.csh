...
cd ~/Zhangsc/VS
#mkdir ~/Zhangsc/VS/etc28
mkdir ~/Zhangsc/VS/Ligands/Ligands28

# make the Ligands directory the current working directory
cd ~/Zhangsc/VS/Ligands/Ligands28
#mkdir test
#cd test
...
cat ~/Zhangsc/VS/Ligands/23_p0.28.mol2 | csplit -ftmp -n4 -ks - '%^@.TRIPOS.MOLECULE%' '/^@.TRIPOS.MOLECULE/' '{*}'
