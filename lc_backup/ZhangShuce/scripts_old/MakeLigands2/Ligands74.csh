...
cd ~/Zhangsc/VS
#mkdir ~/Zhangsc/VS/etc74
mkdir ~/Zhangsc/VS/Ligands/Ligands74

# make the Ligands directory the current working directory
cd ~/Zhangsc/VS/Ligands/Ligands74
#mkdir test
#cd test
...
cat ~/Zhangsc/VS/Ligands/23_p0.74.mol2 | csplit -ftmp -n4 -ks - '%^@.TRIPOS.MOLECULE%' '/^@.TRIPOS.MOLECULE/' '{*}'
