...
cd ~/Zhangsc/VS
#mkdir ~/Zhangsc/VS/etc75
mkdir ~/Zhangsc/VS/Ligands/Ligands75

# make the Ligands directory the current working directory
cd ~/Zhangsc/VS/Ligands/Ligands75
#mkdir test
#cd test
...
cat ~/Zhangsc/VS/Ligands/23_p0.75.mol2 | csplit -ftmp -n4 -ks - '%^@.TRIPOS.MOLECULE%' '/^@.TRIPOS.MOLECULE/' '{*}'
