...
cd ~/Zhangsc/VS
#mkdir ~/Zhangsc/VS/etc59
mkdir ~/Zhangsc/VS/Ligands/Ligands59

# make the Ligands directory the current working directory
cd ~/Zhangsc/VS/Ligands/Ligands59
#mkdir test
#cd test
...
cat ~/Zhangsc/VS/Ligands/23_p0.59.mol2 | csplit -ftmp -n4 -ks - '%^@.TRIPOS.MOLECULE%' '/^@.TRIPOS.MOLECULE/' '{*}'
