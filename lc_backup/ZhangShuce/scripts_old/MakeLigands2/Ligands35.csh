...
cd ~/Zhangsc/VS
#mkdir ~/Zhangsc/VS/etc35
mkdir ~/Zhangsc/VS/Ligands/Ligands35

# make the Ligands directory the current working directory
cd ~/Zhangsc/VS/Ligands/Ligands35
#mkdir test
#cd test
...
cat ~/Zhangsc/VS/Ligands/23_p0.35.mol2 | csplit -ftmp -n4 -ks - '%^@.TRIPOS.MOLECULE%' '/^@.TRIPOS.MOLECULE/' '{*}'
