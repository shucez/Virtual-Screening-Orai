...
cd ~/Zhangsc/VS
#mkdir ~/Zhangsc/VS/etc20
mkdir ~/Zhangsc/VS/Ligands/Ligands20

# make the Ligands directory the current working directory
cd ~/Zhangsc/VS/Ligands/Ligands20
#mkdir test
#cd test
...
cat ~/Zhangsc/VS/Ligands/23_p0.20.mol2 | csplit -ftmp -n4 -ks - '%^@.TRIPOS.MOLECULE%' '/^@.TRIPOS.MOLECULE/' '{*}'
