...
cd ~/Zhangsc/VS
#mkdir ~/Zhangsc/VS/etc61
mkdir ~/Zhangsc/VS/Ligands/Ligands61

# make the Ligands directory the current working directory
cd ~/Zhangsc/VS/Ligands/Ligands61
#mkdir test
#cd test
...
cat ~/Zhangsc/VS/Ligands/23_p0.61.mol2 | csplit -ftmp -n4 -ks - '%^@.TRIPOS.MOLECULE%' '/^@.TRIPOS.MOLECULE/' '{*}'
