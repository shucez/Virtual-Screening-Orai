...
cd ~/Zhangsc/VS
#mkdir ~/Zhangsc/VS/etc48
mkdir ~/Zhangsc/VS/Ligands/Ligands48

# make the Ligands directory the current working directory
cd ~/Zhangsc/VS/Ligands/Ligands48
#mkdir test
#cd test
...
cat ~/Zhangsc/VS/Ligands/23_p0.48.mol2 | csplit -ftmp -n4 -ks - '%^@.TRIPOS.MOLECULE%' '/^@.TRIPOS.MOLECULE/' '{*}'
