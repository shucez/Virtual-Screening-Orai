...
cd ~/Zhangsc/VS
#mkdir ~/Zhangsc/VS/etc66
mkdir ~/Zhangsc/VS/Ligands/Ligands66

# make the Ligands directory the current working directory
cd ~/Zhangsc/VS/Ligands/Ligands66
#mkdir test
#cd test
...
cat ~/Zhangsc/VS/Ligands/23_p0.66.mol2 | csplit -ftmp -n4 -ks - '%^@.TRIPOS.MOLECULE%' '/^@.TRIPOS.MOLECULE/' '{*}'
