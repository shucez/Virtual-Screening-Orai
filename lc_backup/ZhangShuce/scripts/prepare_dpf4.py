...
# 
#
# $Header: /opt/cvs/VSTutorial/prepare_dpf4.py,v 1.3 2007/07/11 23:36:13 rhuey Exp $
#
...
class DockingParameter4FileMaker:
    ...
    def set_flexres(self, flexres_filename):
        ...
        self.flexres_filename = os.path.basename(flexres_filename)
...
if __name__ == '__main__':
    ...
    dm.write_dpf(dpf_filename, parm_list=parameter_list)
