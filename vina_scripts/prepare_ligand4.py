...
# $Header: Zhangsc/prepare_ligand4.py,v 1.2 2007/01/30 01:05:46 rhuey Exp $
#This script functions to convert single molecular .mol2 file into .pdbqt format.
#Note: This script is to be execute by other scripts.
import os 
