#!/bin/csh
#PBS -l nodes=1:ppn=1
# $Id: Zhangsc/scripts/MakeLigands2/Origin2.csh, Shuce 2016/04/01
...
cd ~/Zhangsc/VS
mkdir ~/Zhangsc/VS/Ligands/Ligands8$1
cd ~/Zhangsc/VS/Ligands/Ligands8$1

#create tmp file to split the .mol set into individual compounds

cat ~/Zhangsc/VS/Ligands/23_p1.$1.mol2 | csplit -ftmp -n4 -ks - '%^@.TRIPOS.MOLECULE%' '/^@.TRIPOS.MOLECULE/' '{*}'
